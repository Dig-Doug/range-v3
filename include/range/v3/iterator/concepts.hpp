...
namespace ranges
{
    ...
    namespace detail
    {
        ...
        concept (signed_integer_like_frag_)(D),
            integer_like_<D> CPP_and
            concepts::type<
                decltype(std::integral_constant<bool, (D(-1) < D(0))>{})> CPP_and
        ...
        CPP_concept signed_integer_like_ =
            CPP_concept_ref(detail::signed_integer_like_frag_, D);
        // clang-format on
    } // namespace detail
      /// \endcond
    ...
    namespace detail
    {
        ...
        concept (common_reference_with_4_)(T1, T2, T3, T4),
        ...
        concept (indirectly_unary_invocable_frag_)(F, I),
        ...
        CPP_concept indirectly_unary_invocable_ =
            indirectly_readable<I> &&
            CPP_concept_ref(detail::indirectly_unary_invocable_frag_, F, I);
        // clang-format on
    } // namespace detail
      /// \endcond
    ...
    concept (indirectly_binary_invocable_frag_)(F, I1, I2),
        ...
        CPP_concept_ref(detail::common_reference_with_4_,
    ...
    CPP_concept indirectly_binary_invocable_ =
        ...
        copy_constructible<F> &&
        CPP_concept_ref(ranges::indirectly_binary_invocable_frag_, F, I1, I2);

    CPP_template(typename F, typename I1, typename I2)(
    concept (indirectly_regular_binary_invocable_frag_)(F, I1, I2),
    ...
    CPP_concept indirectly_regular_binary_invocable_ =
        indirectly_readable<I1> && indirectly_readable<I2> &&
        copy_constructible<F> &&
        CPP_concept_ref(ranges::indirectly_regular_binary_invocable_frag_, F, I1, I2);
    /// \endcond
    ...
    CPP_template(typename F, typename I1, typename I2)(
    concept (indirect_binary_predicate_frag_)(F, I1, I2),
    ...
    CPP_concept indirect_binary_predicate_ =
        indirectly_readable<I1> && indirectly_readable<I2> &&
        copy_constructible<F> &&
        CPP_concept_ref(ranges::indirect_binary_predicate_frag_, F, I1, I2);
